...
ALTER TABLE equipo DROP FOREIGN KEY equipo_ibfk_2;
ALTER TABLE equipo ADD FOREIGN KEY (ID_entrenador) REFERENCES Entrenador(ID_entrenador) ON DELETE SET NULL;
