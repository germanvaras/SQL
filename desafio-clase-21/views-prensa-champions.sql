...
-- VW_INFO_JUGADOR: Esta vista proporciona información detallada sobre los jugadores,
-- incluyendo su equipo y entrenador. Ideal para obtener una visión general rápida
-- de los jugadores, su nacionalidad, posición, y afiliación a equipos y entrenadores.
-- Utiliza las tablas Jugador, Equipo y Entrenador.
...
-- VW_DETALLE_PARTIDOS: Ofrece una visión detallada de cada partido, incluyendo equipos,
-- fecha, goles, tarjetas y asistencias. Valiosa para análisis post-partido o estadísticas
-- en tiempo real. Basada en Partido, Equipo, Gol, Tarjeta y Asistencia.
...
-- VW_GOLEADORES_TORNEO: Presenta una lista de los goleadores del torneo, organizada
-- por número de goles marcados. Útil para seguimiento de jugadores destacados y
-- análisis de rendimiento. Apoya en Goleador, Jugador y Torneo.
...
-- VW_CLASIFICACIONES_GRUPO: Muestra las clasificaciones de los grupos, incluyendo
-- puntos, partidos jugados, y estadísticas de goles. Crucial para entender la
-- progresión de los equipos en el torneo. Combina datos de ClasificacionGrupo,
-- Equipo y Torneo.
...
-- VW_RENDIMIENTO_EQUIPOS_TORNEO: Resumen del rendimiento de cada equipo en el torneo,
-- contabilizando partidos jugados, ganados, empatados y perdidos. Esencial para el
-- análisis del rendimiento de los equipos. Basada en Equipo, Partido y Torneo.
